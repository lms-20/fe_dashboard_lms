        ...
        <div className='  min-h-screen bg-neutral-content'>
            ...
            <div className=' mx-auto px-8 text-base-100 py-4 flex'>
                ...
                <div className='basis-8/12 bg-neutral-content'>
                    <iframe width="100%" height="500" src="https://www.youtube.com/embed/tpnOMTPRe40" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                </div>
