                ...
                <div className="navbar flex mb-2 shadow-lg bg-neutral-content text-primary justify-between lg:w-11/12 lg:mx-auto">
                    <div className="">
                        ...
                        <div className='hidden lg:flex lg:flex-col justify-center'>
                            <p className='text-lg text-base-100 font-bold '>Welcome,Rizki Susilo Ramadhan</p>
                        ...
                        <div className="ml-2">
                                ...
                                <div className="m-1 dropdown dropdown-end ">
                                    ...
                                    <ul tabIndex="0" className="text-base-100 p-2 shadow menu dropdown-content bg-neutral rounded-box w-52 mt-2">
                                        <li>
                                            <Link className='btn-hover-primary' to = "/settings"><FontAwesomeIcon icon = {faUserEdit} className='mr-2'/>Settings</Link>
                                        </li> 
                                        <li>
                                            <a className='btn-hover-primary'><FontAwesomeIcon icon = {faDoorOpen} className='mr-2'/>Logout</a>
                                        </li> 
                                    </ul>
                                </div>
